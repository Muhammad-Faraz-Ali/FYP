...
const Index = ({navigation}) => {
  useEffect(() => {
    navigation.pop(); //it will remove this screen from stack and component will unmount, when component will be unmounted then simply navigate to GuestSearch Screen
    return () => navigation.getParent().navigate('GuestSearch');
  }, []);
  return <></>;
};
export default Index;
//////////////*****************this code was copy pasted from GuestScreen*/
...
// import GradesAndSubjects from './components/GradesAndSubjects/index.js';
// //import grades, {subjects} from '../../res/data.js';
// import SearchOnMap from '../guestSearch/components/searchOnMap';
// import {GradesAndSubjectsContext} from '../../Context/index';
// // function ShowData() {
// //   let items = [];
// //   for (var key in Data) {
// //     items.push(Data.key);
...
//     ),
//   );
//   const [coordinates, setCoordiantes] = useState([8.2323123, 7.3432467]);
...
//           setAddress={setAddress}></SearchOnMap>
...
//                 <Text
//                   style={
//                     Age == '20+' ? styles.selectedUser : styles.normalUser
//                   }>
//                   20+
//                 </Text>
//               </TouchableOpacity>
...
//                 <Text
//                   style={
//                     Age == '30+' ? styles.selectedUser : styles.normalUser
//                   }>
//                   30+
//                 </Text>
//               </TouchableOpacity>
...
//                 <Text
//                   style={
//                     Age == '40+' ? styles.selectedUser : styles.normalUser
//                   }>
//                   40+
//                 </Text>
//               </TouchableOpacity>
...
//                 <Text
//                   style={
//                     Age == '50+' ? styles.selectedUser : styles.normalUser
//                   }>
//                   50+
//                 </Text>
//               </TouchableOpacity>
...
//         <TouchableOpacity
//           onPress={() => navigation.navigate('Result', {header: true})}>
//           <Text
//             style={[
//               styles.selectedUser,
//               {
